...
Everything here runs **in the sandbox** against `http://127.0.0.1:8083` — it is
...
1. **Grok browser / computer-use / MCP browser tools**, if listed — open
   `http://127.0.0.1:8083`, glance at the UI, screenshot if supported.
...
node scripts/browser-smoke.mjs http://127.0.0.1:8083/ /workspace/screenshots/app-builder-preview.png
...
```bash
agent-browser open http://127.0.0.1:8083/
