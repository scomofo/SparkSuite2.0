...
try {
  ...
  assert.equal(await page.getByRole("button", { name: /^Practise / }).count(), 10);
  ...
  for (const instrument of ["piano", "ukulele", "mandolin", "banjo", "violin", "lapsteel", "bass", "drums", "vocals", "guitar"]) {
